	...
	<div class="flex justify-around pt-12">
		<div class="flex flex-col items-center w-2/5 ">
			...
			<input
				...
				type="file"
				accept="audio/*,audio/mpeg,audio/mp4,audio-x/flac,audio/x-mpegurl,audio/x-wav,audio/x-ms-wma,audio/x-aiff,audio/x-aac,audio/ogg,audio/mp4a-latm,audio/midi,audio/mpegurl,audio/x-m4a,audio/mp3,audio/x-mp3,audio/x-mpeg,audio/3gpp,audio/3gpp2,audio/vnd.wave"
				capture
				ref="audioInput"
				@keyup.enter="upload"
			/>
