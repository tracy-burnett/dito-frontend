<template>
	<div class="overflow-hidden hero">
		...
		<div v-if="LoginLogoutButton" class="grid grid-cols-3 justify-items-center  mx-[3vw]">
			...
			<span @click="$store.commit('toggleInfobit', 'CreateStorybook');" @touchend="$store.commit('toggleInfobit', 'CreateStorybook'); contribute=false">
			...
			<span @click="$store.commit('toggleInfobit', 'InfoPublish');" @touchend="$store.commit('toggleInfobit', 'InfoPublish'); contribute=false">
			...
			<span @click="$store.commit('toggleInfobit', 'PublicCardList');" @touchend="$store.commit('toggleInfobit', 'PublicCardList'); contribute=false">
		...
		<div v-else class="grid grid-cols-1 justify-items-center  mx-[3vw] mt-[1.7vh]">
			...
			<span @click="$store.commit('toggleInfobit', 'InfoRevitalize');" @touchend="$store.commit('toggleInfobit', 'InfoRevitalize'); contribute=false">
				<div class="cursor-pointer contents" v-if="revitalize == false" @mouseover="revitalize = true"
					@mouseleave="revitalize = false">
					<img class="object-scale-down h-[35vh] w-[20vw]" :src="image4" />
				</div>
