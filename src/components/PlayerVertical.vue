	...
	<div class="flex flex-row h-[15vh] w-4/5 mb-[6vh]" style="position:fixed;">
	   ...
	   <div class="container flex flex-col h-full shadow-xl rounded-xl -mt-[.5vh]">
			...
			<div class="flex flex-col h-[15vh] w-full">
				<div id="waveform" ref="waveform" class="flex waveform h-[9vh] w-full"></div>
				<div class="midwaveform w-full flex h-[1px]"></div>
				<div id="miniwaveform" ref="miniwaveform" class="flex miniwaveform h-[3vh] w-full"></div>
